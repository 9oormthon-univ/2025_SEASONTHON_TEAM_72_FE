...
export const Receipt: React.FC<SettlementReceiptProps> = ({
  ...
  const totalHeight = baseHeight + (items.length * itemHeight) + totalSectionHeight;
    ...
    return (
    <ReceiptContainer style={{ height: `${totalHeight}px` }}>
      ...
      <ContentContainer>
        ...
        <TotalRow style={{ top: `${baseHeight + (items.length * itemHeight) + 16}px` }}>
          <TotalTextLeft>총합</TotalTextLeft>
          <TotalTextCenter>{totalQuantity} 개</TotalTextCenter>
          <TotalTextRight>{totalPrice.toLocaleString()} ₩</TotalTextRight>
        </TotalRow>
      </ContentContainer>
    </ReceiptContainer>
  );
...
// 정산 제목
const SettlementTitle = styled.span`
  color: black;
  font-size: 14px;
  font-family: NanumSquare_ac;
  font-weight: 800;
...
// 총합 - 왼쪽 정렬
const TotalTextLeft = styled.span`
  color: black;
  font-size: 12px;
  font-family: NanumSquare_ac;
  font-weight: 800;
...
// 총합 개수 - 중앙 정렬
const TotalTextCenter = styled.span`
  color: black;
  font-size: 12px;
  font-family: NanumSquare_ac;
  font-weight: 800;
...
`;
// 총합 가격 - 오른쪽 정렬
const TotalTextRight = styled.span`
  color: black;
  font-size: 12px;
  font-family: NanumSquare_ac;
  font-weight: 800;
